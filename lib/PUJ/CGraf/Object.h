...
namespace PUJ
{
  namespace CGraf
  {
    ...
    public:
      ...
      void local_rotate(
        const TReal& t, const TReal& x, const TReal& y, const TReal& z
        );
      ...
      void add_child(
        Object* child, const TReal& x, const TReal& y, const TReal& z
        );
    ...
    protected:
      ...
      void _translate(
        TReal* M, const TReal& x, const TReal& y, const TReal& z
        );
    ...
    protected:
      ...
      std::vector< PUJ::CGraf::Object* > m_Children;
